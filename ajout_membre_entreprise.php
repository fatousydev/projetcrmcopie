    ...
    <style>
        ...
        @media print {
            ...
            .table-container::before {
                content: "Liste des Membres Entreprises - PAMECAS";
                display: block;
                text-align: center;
                font-size: 18px;
                font-weight: bold;
            ...
            <?php if (!empty($membres)): ?>
                <?php foreach ($membres as $m): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($m['numero_compt_entreprise']) ?></td>
                        <td><?= htmlspecialchars($m['nom_entreprise']) ?></td>
                        <td><?= htmlspecialchars($m['nom_dirigant']) ?></td>
                        <td><?= htmlspecialchars($m['prenom_dirigant']) ?></td>
                        <td>
                            <?php $badge_class = [
                                'actif' => 'badge-success',
                        ...
                        <td><?= htmlspecialchars($m['effectif']) ?></td>
                        <td class="comments-cell"><?= htmlspecialchars($m['activites']) ?></td>
                        ...
                        <td class="comments-cell tooltip" title="<?= htmlspecialchars($m['commentaires']) ?>">
                            <?= strlen($m['commentaires']) > 30 ? htmlspecialchars(substr($m['commentaires'], 0, 30)) . '...' : htmlspecialchars($m['commentaires']) ?>
                        </td>
                        <td><?= htmlspecialchars($m['campagne_id']) ?></td>
                        <td><?= htmlspecialchars($m['caisse_id']) ?></td>
                        <td><?= htmlspecialchars($m['guichet_id']) ?></td>
                        <td><?= htmlspecialchars($m['a_beneficie_credit']) ?></td>
                        <td><?= htmlspecialchars($m['id_prospect']) ?></td>
                        <td class="actions-cell">
                            <a href="modifier_membre_entreprise.php?id=<?= $m['id'] ?>" class="action-btn action-btn-edit" title="Modifier">
