...
<nav>
    ...
    <div class="table-controls">
        ...
        <button class="btn btn-success" onclick="showImportPopup()">
        ...
        <a href="statistique.php" class="btn btn-info" onclick="return confirm('Êtes-vous sûr de vouloir statistiques des ventes ?')">
            <i class="fas fa-download"></i>Statistique vente
        </a>
                ...
                <?php foreach ($ventes as $v): ?>
                    <tr>
                        ...
                        <td class="actions-cell">
                            ...
                            <button class="action-btn action-btn-delete" title="Supprimer" onclick="deleteVente(<?= $v['id'] ?>)">
