...
if (isset($_GET['export'])) {
    ...
    // En-têtes
    echo "ID\tNom\tEmail\tRôle\tDate Création\n";
...
<nav>
    ...
    <div class="table-controls">
        ...
        <a href="export_utilisateur.php" class="btn btn-info" onclick="return confirm('Êtes-vous sûr de vouloir exporter les utilisateur?')">
                ...
                <?php foreach ($utilisateurs as $u): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            ][strtolower($u['role'])] ?? 'badge-warning';
                            ?>
                            <span class="badge <?= $badge_class ?>"><?= htmlspecialchars($u['role']) ?></span>
                        </td>
                        
                        <td class="actions-cell">
                            <button class="action-btn action-btn-delete" title="Supprimer" onclick="deleteUtilisateur(<?= $u['id'] ?>)">
