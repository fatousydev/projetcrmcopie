    ...
    <style>
        ...
        @media print {
            ...
            .table-container::before {
                content: "Liste des Produits - PAMECAS";
                display: block;
                text-align: center;
                font-size: 18px;
                font-weight: bold;
...
<nav>
    ...
    <div class="table-controls">
        ...
        <a href="export_produit.php" class="btn btn-info">
                ...
                <?php foreach ($produits as $p): ?>
                    <tr>
                        ...
                        <td class="actions-cell">
                            <button class="action-btn action-btn-delete" title="Supprimer" onclick="deleteProduit(<?= $p['id'] ?>)">
