...
<header>
    ...
    <a href="interfaceadmin.php" class="btn btn-danger">
...
<nav>
    ...
    <div class="table-controls">
        ...
        <a href="tableau_de_bord1.php" class="btn btn-info" onclick="return confirm('Êtes-vous sûr de vouloir la configuration des caisses ?')">
            <i class="fas fa-download"></i>configuration des caisses
        </a>
    </div>
</nav>
