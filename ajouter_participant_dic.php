...
<head>
    ...
    .form-produit input, .form-client select, .form-client textarea {
      margin: 10px 0;
      padding: 10px;
      width: 100%;
...
<body>
    ...
    <div class="container mt-4">
        <h2>Ajouter un participant à une campagne</h2>
        <form action="ajouter_participant.php" method="POST">
            ...
            <a href="interfacedirecteur.php" class="btn btn-secondary">Retour</a>
        </form>
    </div>
